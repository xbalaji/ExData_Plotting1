...
# program to generate the plot 'Global Active Power'
...
# pwrCons <- read.csv(fileName)
# pwr.table <- read.table(unz(zFile, unzFile), header=T, sep=":")
# pwr.table <- read.table(unzFile, nrows=10, header=T)
